  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
      ...
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        ...
        <form class="am-form" method="post" action="<?php echo U('home/Score/to_addscore');?>" enctype="multipart/form-data">
        <div class="am-tab-panel am-fade am-active am-in" id="tab2">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4">
                <input class="am-input-sm" type="text" name="name">
              </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input class="am-input-sm" type="text" name="need_point">
              </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input class="am-input-sm" type="text" name="time_out">
              </div>
