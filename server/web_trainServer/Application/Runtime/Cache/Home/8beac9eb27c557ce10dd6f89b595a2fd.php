...
<div class="am-cf admin-main">
 ...
 <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">旅游管理</strong> / <small>编辑景点</small></div>
      </div>
      ...
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab2">景点编辑</a></li>
      </ul>

     

        <div class="am-tab-panel am-fade am-active am-in" id="tab2">
          <form class="am-form" method="post" action="<?php echo U('home/travel/to_addtravel');?>" enctype="multipart/form-data">
            <div class="am-g am-margin-top">
              <div class="am-u-sm-4 am-u-md-2 am-text-right">
                景点名称
              </div>
              <div class="am-u-sm-8 am-u-md-4">
                <input class="am-input-sm" type="text" name="sce_name" value="<?php echo ($list["0"]["sce_name"]); ?>">
              </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input class="am-input-sm" type="text" name="sce_address" value="<?php echo ($list["0"]["sce_address"]); ?>">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
               <div class="form-group">
                <label for="name">选择站点，如果没有所选站点请到站点管理添加或暂填为空</label>
                <select name="station_id">
                    <option value=""></option>
                  <?php if(is_array($all_station)): foreach($all_station as $key=>$vo): ?><option value="<?php echo ($vo["s_id"]); ?>" 
                    <?php
 if($vo['s_id']==$list[0]['station_id']) echo 'selected="selected"'; ?>
                   ><?php echo ($vo["s_name"]); ?></option><?php endforeach; endif; ?>
                </select>
                </div>
              </div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-12 am-u-md-10">
                <textarea rows="10" placeholder="景点描述..." name="description"><?php echo ($list["0"]["description"]); ?></textarea>
              </div>
            </div>
