    ...
    <div class="am-cf am-padding am-padding-bottom-0">
     ...
     <div class="am-tabs am-margin" data-am-tabs="">
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab2">商品编辑</a></li>
      </ul>

     
     
        <div class="am-tab-panel am-fade am-active am-in" id="tab2">
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><form class="am-form" method="post" action="<?php echo U('home/commodity/to_editcommodity',array('comm_id'=>$vo['comm_id']));?>">
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-12 am-u-md-10">
                <textarea rows="10" placeholder="商品描述..." name="comm_descr"><?php echo ($vo["comm_descr"]); ?></textarea>
