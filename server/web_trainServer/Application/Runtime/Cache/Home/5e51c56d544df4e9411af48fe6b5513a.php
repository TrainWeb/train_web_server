...
<head>
  ...
  <link rel="stylesheet" href="/web_trainServer/Public/css/bootstrap-switch.css">
  <link rel="stylesheet" href="/web_trainServer/Public/css/bootstrap.min.css">
  ...
  <script type="text/javascript">
   function find_click(){
    ...
    var pageurl  = "/web_trainServer/index.php/home/score/findscore/find/"+findtext+".html";
...
<div class="am-cf admin-main">
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a href="<?php echo U('home/Score/score');?>"><span class="am-icon-sign-out"></span> 积分奖品<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">积分奖品</strong></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('home/score/addscore');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div>
          </div>
        </div>
      ...
      <div class="am-g" style="padding-top:20px">
       ...
       <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="col-md-4">
          <div class="thumbnail">
            <img alt="300x200" src="<?php echo ($vo["reward_picture"]); ?>" style="height:200px" />
            <div class="caption">
              <h3>
                <?php echo ($vo["reward_name"]); ?>
              </h3>
              <p>
               所需积分：<?php echo ($vo["need_points"]); ?>
              </p>
              <p>截止时间：<?php echo ($vo["time_out"]); ?> 
              </p>
              <p>
                 <a class="btn btn-primary" href="<?php echo U('home/score/editscore',array('id'=>$vo['reward_id']));?>">编辑</a> <a class="btn" href="<?php echo U('home/score/deletescore',array('id'=>$vo['reward_id']));?>">删除</a>
              </p>
  ...
  <!-- content end -->
   ...
   <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a class="button button-primary button-rounded" href="<?php echo U('home/Score/addscore');?>"><span class="am-icon-plus"></span> 新增奖励</a>
            </div>
          </div>
        </div>
        ...
        <div class="am-u-sm-12 am-u-md-3">
          ...
          <span class="am-input-group-btn">
            <button class="am-btn am-btn-default" type="button">搜索奖励</button>
          </span>
          </div>
        </div>
   </div>
         ...
         <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="col-md-4">
          <div class="thumbnail">
            ...
            <div class="caption">
              ...
              <p>所需积分：<?php echo ($vo["need_points"]); ?>
              </p>
              <p>截止日期：<?php echo ($vo["time_out"]); ?></p>
              <p>
                 <a class="btn btn-primary" href="<?php echo U('home/score/editscore',array('id'=>$vo['reward_id']));?>">编辑</a> <a class="btn" href="<?php echo U('home/score/deletescore',array('id'=>$vo['reward_id']));?>">删除</a>
              </p>
