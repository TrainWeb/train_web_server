        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('home/admin/addstation');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div>
          </div>
        </div>
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<?php echo U('home/admin/editstation',array('S_ID'=>$vo[s_id]));?>"><button class="am-btn am-btn-default am-btn-xs am-text-secondary" type="button"><span class="am-icon-pencil-square-o"></span> 查看及编辑</button></a>
                      <a href="<?php echo U('home/admin/deletestation',array('S_ID'=>$vo[s_id]));?>"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" type="button"><span class="am-icon-trash-o"></span> 删除</button></a>
                    </div>
                  </div>
                </td>
