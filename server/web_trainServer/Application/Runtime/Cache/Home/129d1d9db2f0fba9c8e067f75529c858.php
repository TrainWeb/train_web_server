...
<div class="am-cf admin-main">
      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="<?php echo U('home/admin/station');?>" class="am-cf"><span class="am-icon-check"></span> 高铁站点<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">站点管理/编辑站点</strong></div>
      </div>
      ...
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><form class="am-form" method="post" action="<?php echo U('home/admin/to_editstation',array('s_id'=>$vo['s_id']));?>">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4">
                <input class="am-input-sm" type="text" name="station" value="<?php echo ($vo["s_name"]); ?>">
              </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input class="am-input-sm" type="text" name="province" value="<?php echo ($vo["s_province"]); ?>">
              </div>
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
               <button class="btn" type="submit" style="float:right"><span class="glyphicon glyphicon-ok"></span>提交编辑</button>
              </div>
            </div>
