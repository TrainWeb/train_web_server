...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">商品管理</strong>/<small>商品添加</small></div>
      </div>
      ...
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab2">商品添加</a></li>
      </ul>

     

        <div class="am-tab-panel am-fade am-active am-in" id="tab2">
          <form class="am-form" method="post" action="<?php echo U('Uploadimg/Uploadimg2');?>" enctype="multipart/form-data">
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-12 am-u-md-10">
                <textarea rows="10" placeholder="商品描述..." name="fooddiscribe"></textarea>
              </div>
            </div>
            <div class="am-g am-margin-top-sm">
              <div class="am-u-sm-12 am-u-md-2 am-text-right admin-form-text">
