...
<div class="am-cf admin-main">
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a href="<?php echo U('home/food/food');?>"><span class="am-icon-table"></span> 食品管理<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">路线管理</strong>/<small>路线添加</small></div>
      </div>
      ...
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab2">路线添加</a></li>
      </ul>

     

        <div class="am-tab-panel am-fade am-active am-in" id="tab2">
          <form class="am-form"  method="post" action="<?php echo U('home/route/to_addroute');?>">
            <div class="am-g am-margin-top">
              <div class="am-u-sm-4 am-u-md-2 am-text-right">
                路线编号
              </div>
              <div class="am-u-sm-8 am-u-md-4">
                <input class="am-input-sm" type="text" name="route_number">
              </div>
      ...
      <table class="table table-bordered table-condensed" style="margin-top:20px;" id="routetable">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <input class="am-input-sm" type="text" name="station_name[]">
            </td>
            <td>
              <input class="am-input-sm" type="text" name="station_arrivetime[]">
            </td>
            <td>
              <input class="am-input-sm" type="text" name="station_leavetion[]">
            </td>
            <td>
             <!-- <a href="javascript:void(0);" name="removeRow" onclick="removeRow(this);"><span class="am-icon-trash-o"></span> 删除</a> -->
            </td>
          </tr>
      ...
      <button class="btn" type="submit" style="float:right"><span class="glyphicon glyphicon-ok"></span>提交</button>
       <!-- <button class="am-btn am-btn-default am-btn-xs am-text-secondary" name="addRow">添加一行</button> -->
       <a href="javascript:void(0);" name="addRow">添加一行</a>
          </div>
        </form>
      </div>
