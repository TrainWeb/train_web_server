...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">积分管理</strong>/<small>奖励添加</small></div>
      </div>
      ...
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab2">奖励添加</a></li>
      </ul>

      <?php if(is_array($list)): foreach($list as $key=>$vo): ?><form class="am-form" method="post" action="<?php echo U('home/score/to_editscore',array('id'=>$vo['reward_id']));?>" enctype="multipart/form-data">
        <div class="am-tab-panel am-fade am-active am-in" id="tab2">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4">
                <input class="am-input-sm" type="text" name="name" value="<?php echo ($vo["reward_name"]); ?>">
              </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input class="am-input-sm" type="text" name="need_point" value="<?php echo ($vo["need_points"]); ?>">
              </div>
              <div class="am-hide-sm-only am-u-md-6">积分</div>
            </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input class="am-input-sm" type="text" name="time_out" value="<?php echo ($vo["time_out"]); ?>">
              </div>
            ...
            <div>
              <center><input type="submit" name="" value="提交"></center>
