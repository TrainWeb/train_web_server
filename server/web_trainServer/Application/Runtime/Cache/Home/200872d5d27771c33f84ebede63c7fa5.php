<?php if (!defined('THINK_PATH')) exit();?>新增<!doctype html>
...
<div class="am-cf admin-main">
      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            ...
            <li><a href="javascript:void(0);"><span class="am-icon-puzzle-piece"></span> 高铁路线<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
          </ul>
        </li>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">路线管理</strong></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('home/admin/addroute');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div>
          </div>
        </div>
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 查看路线详情</button>
                      <button class="am-btn am-btn-default am-btn-xs am-text-danger" ><a href=""><span class="am-icon-trash-o"></span> 删除</a></button>
                    </div>
                  </div>
                </td>
              </tr>
