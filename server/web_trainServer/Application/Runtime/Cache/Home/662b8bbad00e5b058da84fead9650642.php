...
<head>
  ...
  <script type="text/javascript">
   function find_click(){
    ...
    var pageurl  = "/web_trainServer/index.php/home/vedio/findvedio/find/"+findtext+".html";
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('home/vedio/addvedio');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div>
          </div>
        </div>
      ...
      <div class="am-g" style="padding-top:20px">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="col-md-4">
          <div class="thumbnail">
            <img alt="300x200" src="<?php echo ($vo["f_image_url"]); ?>" style="height:400px;width:300px" />
            <div class="caption">
              <h3>
              视频名称：<?php echo ($vo["f_name"]); ?>
              </h3>
              <p>
              视频类型：<?php echo ($vo["f_type"]); ?>
              </p>
              <p>
              上映时间：<?php echo ($vo["f_year"]); ?>
              </p>
              <p>
              评分：<?php echo ($vo["f_point"]); ?>
              </p>
              <p>
              视频价格：<?php echo ($vo["f_wprice"]); ?>
              </p>
              <p>
                 <a class="btn btn-primary" href="<?php echo U('home/Vedio/editvedio',array('id'=>$vo[f_id]));?>">编辑</a> <a class="btn" href="<?php echo U('home/vedio/deletevedio',array('id'=>$vo['f_id']));?>">删除</a>
                 <a class="btn btn-primary" href="<?php echo U('home/vedio/vediocomment',array('id'=>$vo['f_id']));?>" style="float:right;">查看评论</a>
              </p>
