...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">食品管理/搜索结果</strong></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('home/food/addfood');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div>
          </div>
        </div>
       ...
       <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="col-md-4">
          ...
          <div class="comm_id" style="display:none"><?php echo ($vo["comm_id"]); ?></div>
            ...
            <?php if( $vo['comm_discounted'] != '10' ){ echo '<span class="am-badge am-badge-danger">'.$vo['comm_discounted'].'折优惠中</span></p>'; }?>
              <p>
                 <a class="btn btn-primary" href="<?php echo U('home/food/editfood',array('comm_id'=>$vo['comm_id']));?>">编辑</a> <a class="btn" href="<?php echo U('Food/deletefood',array('comm_id'=>$vo['comm_id']));?>">删除</a>
                  <a class="btn btn-primary" href="<?php echo U('home/food/commentfood',array('comm_id'=>$vo['comm_id']));?>" style="float:right;">查看评论</a>
              </p>
            </div>
          </div>
