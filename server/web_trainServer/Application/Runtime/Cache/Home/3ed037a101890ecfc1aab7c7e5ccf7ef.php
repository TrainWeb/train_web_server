...
<div class="am-cf admin-main">
      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="javascript:void(0);" class="am-cf"><span class="am-icon-check"></span> 高铁站点<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">站点管理/站点搜索</strong></div>
      </div>
...
<div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('home/station/addstation');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div>
          </div>
        </div>
        ...
        <div class="am-u-sm-12 am-u-md-3">
          <div class="am-input-group am-input-group-sm">
            <input class="am-form-field findstation" type="text">
          <span class="am-input-group-btn">
            <button class="am-btn am-btn-default" type="button" onclick="findstation()">搜索</button>
          </span>
          </div>
        </div>
      </div>
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
               <th class="table-title">站点</th><th class="table-type">所在省份</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                <td><?php echo ($vo["s_name"]); ?></td>
                <td><?php echo ($vo["s_province"]); ?></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<?php echo U('home/station/editstation',array('S_ID'=>$vo[s_id]));?>"><button class="am-btn am-btn-default am-btn-xs am-text-secondary" type="button"><span class="am-icon-pencil-square-o"></span> 查看及编辑</button></a>
                      <a href="<?php echo U('home/station/deletestation',array('S_ID'=>$vo[s_id]));?>"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" type="button"><span class="am-icon-trash-o"></span> 删除</button></a>
                    </div>
                  </div>
                </td>
...
<script type="text/javascript">
  function findstation(){
      var findtext = $('.findstation').val();
    var pageurl  = "/web_trainServer/index.php/home/station/findstation/find/"+findtext+".html";
