...
<head>
  ...
  <script type="text/javascript">
   function find_click(){
    ...
    var pageurl  = "<?php echo U('home/travel/findtravel');?>?findtext="+findtext;
...
<div class="am-cf admin-main">
    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a href="<?php echo U('home/Score/score');?>"><span class="am-icon-sign-out"></span> 积分奖品</a></li>
         <li><a href="<?php echo U('home/Video/video');?>"><span class="am-icon-sign-out"></span> 视频管理</a></li>
         <li><a href="<?php echo U('home/Travel/travel');?>"><span class="am-icon-sign-out"></span> 旅行管理<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
      </ul>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">旅游管理</strong></div>
      </div>
...
<div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-9">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a class="button button-primary button-rounded" href="<?php echo U('home/Travel/addtravelpoint');?>"><span class="am-icon-plus"></span> 新增景点</a>
            </div>
          </div>
        </div>
        ...
        <div class="am-u-sm-12 am-u-md-3">
          ...
          <span class="am-input-group-btn">
            <button class="am-btn am-btn-default" type="button" onclick="find_click()">搜索景点</button>
          </span>
          </div>
        </div>
      </div>
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
               <th class="table-title">景点</th><th class="table-type">地址</th><th class="table-type">所在站点</th><th class="table-set">查看详情</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                <td><?php echo ($vo["sce_name"]); ?></td>
                <td><?php echo ($vo["sce_address"]); ?></td>
                <td><?php echo ($vo["station"]); ?></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>   图片及描述</button>
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 地图路线</button>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<?php echo U('home/travel/edittravel',array('id'=>$vo['sce_id']));?>"><button class="am-btn am-btn-default am-btn-xs am-text-secondary" type="button"><span class="am-icon-pencil-square-o"></span> 编辑</button></a>
                      <a href="<?php echo U('home/travel/deletetravel',array('id'=>$vo['sce_id']));?>"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" type="button"><span class="am-icon-trash-o"></span> 删除</button></a>
                    </div>
                  </div>
                </td>
